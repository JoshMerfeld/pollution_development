...
rownames(data) <- c("shapefile", "coal plants", "wind", "pollution", "agriculture", "nightlights")
...
kable(
  ...
  footnote(
           "Note: NCAR stands for the National Center for Atmospheric Research. Additional information on Global Energy Monitor and NCAR can be found on their websites, at https://globalenergymonitor.org/projects/global-coal-plant-tracker and https://climatedataguide.ucar.edu/, respectively.", 
           general_title = "",
           threeparttable = TRUE,
           footnote_as_chunk = TRUE
           ) %>%
