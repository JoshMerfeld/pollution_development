...
kable(
  ...
  footnote(
           general = c(
                       "Note: Standard errors are in parentheses and are clustered at the village level. The sample is restricted to village-years after a coal plant was built near the village.",
                       "* p<0.10 ** p<0.05 *** p<0.01"
                       ), 
           general_title = "",
           threeparttable = TRUE
