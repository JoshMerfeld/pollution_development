...
```{r yield8monthly, include = TRUE, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Effects of pollution on productivity by month"}
...
# Quantifying the overall effects of pollution on agricultural productivity
...
In the output data, I observe values for 2001 and 2011. I can calculate the overall change in log output across the two years, as well as the overall change in pollution levels. I use the most conservative point estimate *without* coal plants in \@ref(tab:yield7ivdiffindiff), which is $-0.223$. For each district, I calculate the counterfactual for each crop as follows:
...
```{r yielddatamaps, include = TRUE, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "The maps show the district-level yields of each crop in 2001.", fig.footer = "Yield data comes from ICRISAT."}
