...
Although we have made much progress over the last several decades, poverty and inequality remain important challenges in the developing world [@alvaredo2015recent]. Poverty is particularly prevalent in rural areas, where the majority of the world's poor live [@dercon2009rural], and in the agricultural sector, where the majority of the world's poor work [@christiaensen2011evolving]. As such, agricultural productivity is a key determinant of poverty in developing countries [@dercon2009rural], meaning that any threat to agricultural productivity is also a threat to poverty reduction.
