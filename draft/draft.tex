...
\begin{figure}
\includegraphics{draft_files/figure-latex/yielddatamaps-1} \caption[The maps show the district-level yields of each crop in 2001]{The maps show the district-level yields of each crop in 2001.}\label{fig:yielddatamaps}\floatfoot*{Yield data comes from ICRISAT.}
\end{figure}
