...
\begin{figure}
\includegraphics{draft_files/figure-latex/yield8monthly-1} \caption[Effects of pollution on productivity by month]{Effects of pollution on productivity by month}\label{fig:yield8monthly}\floatfoot*{Coefficients are from a single regression, where the outcome is (log) agricultural yield and pollution in each of the five months of the season is instrumented with wind in each month. Standard errors are indicated by the bars and are clustered at the village level.}
\end{figure}
...
\begin{figure}
\includegraphics{draft_files/figure-latex/yielddatamaps-1} \caption[District-level yields in 2001]{District-level yields in 2001}\label{fig:yielddatamaps}\floatfoot*{Yield data comes from ICRISAT.}
\end{figure}
