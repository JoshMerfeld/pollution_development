...
# Don't need these months
pollution <- pollution %>% filter(!(month %in% c(4, 5)), is.na(mean)==F)
...
pollution$year[pollution$month %in% c(1:3)] <- pollution$year[pollution$month %in% c(1:3)] - 1

pollution$m1 <- NA
pollution$m1[pollution$month==6] <- pollution$mean[pollution$month==6]
pollution$m1[pollution$month==11] <- pollution$mean[pollution$month==11]
pollution$m2 <- NA
pollution$m2[pollution$month==7] <- pollution$mean[pollution$month==7]
pollution$m2[pollution$month==12] <- pollution$mean[pollution$month==12]
pollution$m3 <- NA
pollution$m3[pollution$month==8] <- pollution$mean[pollution$month==8]
pollution$m3[pollution$month==1] <- pollution$mean[pollution$month==1]
pollution$m4 <- NA
pollution$m4[pollution$month==9] <- pollution$mean[pollution$month==9]
pollution$m4[pollution$month==2] <- pollution$mean[pollution$month==2]
pollution$m5 <- NA
pollution$m5[pollution$month==10] <- pollution$mean[pollution$month==10]
pollution$m5[pollution$month==3] <- pollution$mean[pollution$month==3]
